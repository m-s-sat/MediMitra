                  ...
                  <div className="mb-6">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <button
                        ...
                        className={`flex items-center justify-center space-x-2 p-3 rounded-lg border ${selectedType === 'physical'
                      ...
                      <button
                        ...
                        className={`flex items-center justify-center space-x-2 p-3 rounded-lg border ${selectedType === 'video'
                          ? 'border-blue-600 bg-blue-50 text-blue-600'
                          : 'border-gray-300 text-gray-700 hover:bg-gray-50'
                          } transition-colors`}
                      >
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      {selectedDoctor.availableSlots.map((slot, index) => (
                        <button
                          ...
                          className={`p-2 text-sm rounded-lg border ${selectedTime === slot
                            ? 'border-blue-600 bg-blue-50 text-blue-600'
                            : 'border-gray-300 text-gray-700 hover:bg-gray-50'
                            } transition-colors`}
                        >
